...
/*================================================================================================*/
/* Purpose:     constant and function prototype definitions used by the FSL                       */
/*================================================================================================*/
/*                                                                                                */
/* Warranty Disclaimer                                                                            */
/*                                                                                                */
...
/*----------------------------------------------------------------------------------------------*/
/* Purpose:      copies the content of FSL_RCD_ROM segment into the RAM                         */
/*                                                                                              */
/* Input:        -                                                                              */
/* Output:       -                                                                              */
/* Returned:     -                                                                              */
/*----------------------------------------------------------------------------------------------*/
extern __far_func void FSL_CopySection(void);
...
/*                   = 0x05(FSL_ERR_PARAMETER), parameter error or internal high-speed          */
/*                                              oscillator isn't started                        */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_Init(const __far fsl_descriptor_t __far* descriptor_pstr);
...
/*                   = 0xFF(FSL_BUSY), normal and means "process was started"                   */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_Write(__near fsl_write_t __near* write_pstr);
...
/*                                      or FSL is suspending.                                   */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_GetSecurityFlags(__near fsl_u08 __near* data_destination_pu08);
...
/*                                      or FSL is suspending.                                   */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_GetBootFlag(__near fsl_u08 __near* data_destination_pu08);
...
/*                                      or FSL is suspending.                                   */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_GetSwapState(__near fsl_u08 __near* data_destination_pu08);
...
/*                                      or FSL is suspending.                                   */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_GetBlockEndAddr(__near fsl_getblockendaddr_t __near* getblockendaddr_pstr);
...
/*                                      or FSL is suspending.                                   */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_GetFlashShieldWindow(__near fsl_fsw_t __near* getfsw_pstr);
...
/*                   = 0xFF(FSL_BUSY), normal and means "process was started"                   */
/*----------------------------------------------------------------------------------------------*/
extern __far_func fsl_u08  FSL_SetFlashShieldWindow(__near fsl_fsw_t __near* setfsw_pstr);
